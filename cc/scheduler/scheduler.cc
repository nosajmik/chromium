  ...
  do {
    ...
    switch (action) {
      ...
      case SchedulerStateMachine::Action::SEND_BEGIN_MAIN_FRAME:
        fprintf(stderr,"Scheduler::ProcessScheduledActions case SchedulerStateMachine::Action::SEND_BEGIN_MAIN_FRAME\n");
      ...
      case SchedulerStateMachine::Action::
        ...
        fprintf(stderr,"Scheduler::ProcessScheduledActions case SchedulerStateMachine::Action::NOTIFY_BEGIN_MAIN_FRAME_NOT_EXPECTED_UNTIL\n");
      ...
      case SchedulerStateMachine::Action::
        ...
        fprintf(stderr,"Scheduler::ProcessScheduledActions case SchedulerStateMachine::Action::NOTIFY_BEGIN_MAIN_FRAME_NOT_EXPECTED_SOON\n");        
      ...
      case SchedulerStateMachine::Action::COMMIT:
        fprintf(stderr,"Scheduler::ProcessScheduledActions case SchedulerStateMachine::Action::COMMIT\n");        
      ...
      case SchedulerStateMachine::Action::POST_COMMIT:
        fprintf(stderr,"Scheduler::ProcessScheduledActions case SchedulerStateMachine::Action::POST_COMMIT\n");              
        client_->ScheduledActionPostCommit();
        state_machine_.DidPostCommit();
        break;
      case SchedulerStateMachine::Action::ACTIVATE_SYNC_TREE:
        fprintf(stderr,"Scheduler::ProcessScheduledActions case SchedulerStateMachine::Action::ACTIVATE_SYNC_TREE\n");                    
      ...
      case SchedulerStateMachine::Action::PERFORM_IMPL_SIDE_INVALIDATION:
        fprintf(stderr,"Scheduler::ProcessScheduledActions case SchedulerStateMachine::Action::PERFORM_IMPL_SIDE_INVALIDATION\n");                    
